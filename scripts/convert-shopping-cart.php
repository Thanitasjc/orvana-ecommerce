...
$htmlPath = dirname(__DIR__) . '/_html_source/shopping-cart.html';
...
$sections = [
    'components/cart-page-title' => ['<!-- Page Title -->', '<!-- /Page Title -->'],
    'components/cart-content' => ['<!-- Shopping Cart -->', '<!-- /Shopping Cart -->'],
];
