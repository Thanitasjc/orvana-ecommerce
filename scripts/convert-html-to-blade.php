...
$htmlPath = dirname(__DIR__) . '/_html_source/index.html';
...
$sections = [
    'components/scroll-top' => ['<!-- Scroll Top -->', '<!-- Preload -->'],
    'components/preload' => ['<!-- Preload -->', '<!-- /Preload -->'],
    'components/header' => ['<!-- Header -->', '<!-- /Header -->'],
    'components/slideshow' => ['<!-- Slide Show -->', '<!-- /Slide Show -->'],
    'components/category' => ['<!-- Category -->', '<!-- /Category -->'],
    'components/product' => ['<!-- Product -->', '<!-- /Product -->'],
    'components/lookbook' => ['<!-- Lookbook -->', '<!-- /Lookbook -->'],
    'components/banner-shop-detail' => ['<!-- Banner Shop Detail -->', '<!-- /Banner Shop Detail -->'],
    'components/related-product' => ['<!-- Related Product -->', '<!-- /Related Product -->'],
    'components/testimonial' => ['<!-- Testimonial -->', '<!-- /Testimonial -->'],
    'components/banner-image-text' => ['<!-- Banner Image Text -->', '<!-- /Banner Image Text -->'],
    'components/box-icon' => ['<!-- Box Icon -->', '<!-- /Box Icon -->'],
    'components/footer' => ['<!-- Footer -->', '<!-- /Footer -->'],
    'partials/mobile-menu' => ['<!-- Mobile Menu -->', '<!-- /Mobile Menu -->'],
    'partials/forgot-password' => ['<!-- Forgot Password -->', '<!-- /Forgot Password -->'],
    'partials/quick-add' => ['<!-- Quick Add -->', '<!-- /Quick Add -->'],
    'partials/shopping-cart' => ['<!-- Shoping Cart -->', '<!-- /Shoping Cart -->'],
    'partials/quick-view' => ['<!-- Quick View -->', '<!-- /Quick View -->'],
    'partials/wishlist' => ['<!-- Wishlist -->', '<!-- /Wishlist -->'],
    'partials/register' => ['<!-- Register -->', '<!-- /Register -->'],
    'partials/login' => ['<!-- Login -->', '<!-- /Login -->'],
    'partials/search' => ['<!-- Open Search -->', '<!-- End Open Search -->'],
];
