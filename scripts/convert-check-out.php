...
$htmlPath = dirname(__DIR__) . '/_html_source/check-out.html';
...
$sections = [
    'components/checkout-page-title' => ['<!-- Page Title -->', '<!-- /Page Title -->'],
    'components/checkout-content' => ['<!-- Check Out -->', '<!-- /Check Out -->'],
];
