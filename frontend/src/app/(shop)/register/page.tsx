...
import { MEMBER_TOKEN_KEY, setCookie } from "@/lib/auth/cookies";
...
export default function RegisterPage() {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError((err as { message?: string }).message ?? "สมัครไม่สำเร็จ");
    } finally {
      setLoading(false);
    }
  }
                ...
                <form onSubmit={onSubmit}>
                  <div className="tp-login-option">
                    <div className="tp-login-social mb-10 d-flex flex-wrap align-items-center justify-content-center">
                      ...
                      <div className="tp-login-option-item">
                        <a href="#">
                          <img className="apple" src="/assets/img/icon/login/apple.svg" alt="" />
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="tp-login-mail text-center mb-40">
                      <p>
                        or Sign up with <a href="#register-email">Email</a>
                      </p>
                    </div>

                    <div className="tp-login-input-wrapper" id="register-email">
                      <div className="tp-login-input-box">
                        <div className="tp-login-input">
                          <input id="name" name="name" type="text" placeholder="Shahnewaz Sakil" required />
                        </div>
                      ...
                      <div className="tp-login-input-box">
                        <div className="tp-login-input">
                          <input id="email" name="email" type="email" placeholder="shofy@mail.com" required />
                        </div>
                        <div className="tp-login-input-title">
                      ...
                      <div className="tp-login-input-box">
                        <div className="tp-login-input">
                          <input id="phone" name="phone" type="text" placeholder="08x-xxx-xxxx" />
                        </div>
                        <div className="tp-login-input-title">
                      ...
                      <div className="tp-login-input-box">
                        ...
                        >
                          <span className={showPassword ? "open-eye" : "open-close"}>
                      ...
                      <div className="tp-login-input-box">
                        ...
                        >
                          <span className={showConfirmPassword ? "open-eye" : "open-close"}>
                    ...
                    {error ? <p className="text-danger mb-20">{error}</p> : null}
