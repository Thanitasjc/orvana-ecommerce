...
export default function MemberLoginPage() {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setCookie(MEMBER_TOKEN_KEY, res.data.token, rememberMe ? 30 : 7);
      router.push("/account");
    } catch (err: unknown) {
            ...
            <div className="col-xl-6 col-lg-8">
              <div className="tp-login-wrapper">
                <div className="tp-login-top text-center mb-30">
                  <h3 className="tp-login-title">เข้าสู่ระบบสมาชิก</h3>
                  <p className="mb-10 text-muted">
                    สมาชิกเข้าได้เฉพาะพื้นที่บัญชีของตัวเอง — ไม่สามารถเข้า POS หรือ Admin
                  </p>
                  <p>
                    ยังไม่มีบัญชี?{" "}
                    <span>
                ...
                <form onSubmit={onSubmit}>
                  <div className="tp-login-option">
                    ...
                    <div className="tp-login-mail text-center mb-40">
                      <p>
                        or Sign in with <a href="#login-email">Email</a>
                      </p>
                    </div>

                    <div className="tp-login-input-wrapper" id="login-email">
                      <div className="tp-login-input-box">
                        <div className="tp-login-input">
                          <input id="email" name="email" type="email" placeholder="อีเมล" required />
                        </div>
