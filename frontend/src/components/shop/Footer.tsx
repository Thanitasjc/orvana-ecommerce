...
export function Footer() {
  return (
    <footer>
      <div className="tp-footer-area tp-footer-style-2" data-bg-color="footer-bg-white">
              ...
              <div className="row align-items-center">
                <div className="col-md-6">
                  <div className="tp-footer-copyright">
                    <p>© 2023 All Rights Reserved | HTML Template by <Link href="/">Themepure</Link>.</p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="tp-footer-payment text-md-end">
                    <p>
                      <img src="/assets/img/footer/footer-pay-2.png" alt="payment" />
                    </p>
                  </div>
                </div>
              </div>
