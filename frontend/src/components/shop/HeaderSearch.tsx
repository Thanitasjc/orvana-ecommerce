...
export function HeaderSearch({ compact = false }: HeaderSearchProps) {
  ...
  return (
    <>
      <style>{`
        .tp-header-search-2.tp-header-search-pill input[type="search"] {
          width: 100%;
          height: 44px;
          border-radius: 999px;
        ...
        .tp-header-search-2.tp-header-search-pill input[type="search"]:focus {
          outline: none;
          border-color: var(--tp-theme-secondary, #821f40);
        }
      `}</style>
      <form
        onSubmit={submit}
        role="search"
        className="tp-header-search-2 tp-header-search-pill w-100"
      >
